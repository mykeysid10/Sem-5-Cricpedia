...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Dark_Blue'";
...
?>
				<div class="vertical-menu" style="margin-top:-1.7%;">
					...
					<a href="sri-lanka_players.php" class="active">Sri Lanka</a>
	...
	else
	{
		?>
			<div class="vertical-menu" style="margin-top:-1.7%;">
				...
				<a href="sri-lanka_players.php?logincheck=1" class="active">Sri Lanka</a>
	 ...
	 ?>
<!-- ____________________________________________________________________________________________ -->
		<img src="img/dimuth.PNG" class="i2center">
		<table class="center">
			<tr>
				<th>Player_Name</th>
				<th>DOB</th>
