...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Red'";
...
<div class="vertical-menu" style="margin-top:-1.7%;">
	...
	<a href="england_players.php"class="active">England</a>
...
<?php
		...
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="england_players.php?logincheck=1"class="active">England</a>
	 ...
	 ?>
<!-- ____________________________________________________________________________________________ -->
    <img src="img/morgan.PNG" class = "i2center">
    <table class="center">
        <tr>
            <th>Player_Name</th>
            <th>DOB</th>
