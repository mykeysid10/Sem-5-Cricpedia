...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Green2'";
...
?>
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="bangladesh_players.php" class="active">Bangladesh</a>
...
<!-- ____________________________________________________________________________________________ -->
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="bangladesh_players.php?logincheck=1" class="active">Bangladesh</a>
	...
	?>
<!-- ____________________________________________________________________________________________ -->
	<img src="img/shakib.PNG" class="i2center">
	<table class="center">
		<tr>
			<th>Player_Name</th>
			<th>DOB</th>
