...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Yellow'";
...
<!-- ____________________________________________________________________________________________ -->
	...
	?>
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="australia_players.php" class="active">Australia</a>
	...
	?>
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="australia_players.php?logincheck=1" class="active">Australia</a>
	...
	?>
<!-- ____________________________________________________________________________________________ -->
		<img src="img/finch.PNG" class="i2center">
		<table class="center">
			<tr>
				<th>Player_Name</th>
				<th>DOB</th>
