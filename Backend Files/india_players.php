...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Blue'";
...
<!-- ______________________________________________________________________________________________________________________ -->
			...
			?>
				<div class="vertical-menu" style="margin-top:-1.7%;">
					...
					<a href="india_players.php"class="active">India</a>
				...
				?>
						<div class="vertical-menu" style="margin-top:-1.7%;">
							...
							<a href="india_players.php?logincheck=1"class="active">India</a>
				...
				?>
        <img src="img/kohli.PNG" class="i2center">
<!-- ____________________________________________________________________________________________ -->
        <table class="center">
            <tr>
                <th>Player_Name</th>
