...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Blue2'";
...
<div class="back">
	...
	?>
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="afghanistan_players.php" class="active">Afghanistan</a>
		</div>
		<?php
	}
	else{
	...
	<!-- ____________________________________________________________________________________________ -->
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="afghanistan_players.php?logincheck=1" class="active">Afghanistan</a>
		</div>
	 <?php
	}
	 ?>
	<!-- ____________________________________________________________________________________________ -->
		<img src="img/naib.PNG" class="i2center">
