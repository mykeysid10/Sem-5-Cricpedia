...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Springbok'";
...
?>
				<div class="vertical-menu" style="margin-top:-1.7%;">
					...
					<a href="south-africa_players.php" class="active">South Africa</a>
		...
		?>
				<div class="vertical-menu" style="margin-top:-1.7%;">
					...
					<a href="south-africa_players.php?logincheck=1" class="active">South Africa</a>
		...
		?>
<!-- ____________________________________________________________________________________________ -->
				<img src="img/faf.PNG" class="i2center">
				<table class="center">
					<tr>
						<th>Player_Name</th>
						<th>DOB</th>
