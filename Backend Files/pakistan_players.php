...
$query = "SELECT * FROM playersstats WHERE JerseyColor = 'Green'";
...
<!-- ____________________________________________________________________________________________ -->
		...
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="pakistan_players.php" class="active">Pakistan</a>
		...
		<div class="vertical-menu" style="margin-top:-1.7%;">
			...
			<a href="pakistan_players.php?logincheck=1" class="active">Pakistan</a>
		...
		?>
<!-- ____________________________________________________________________________________________ -->
		<img src="img/babar.PNG" class="i2center">
		<table class="center">
			<tr>
				<th>Player_Name</th>
				<th>DOB</th>
